...
def filter_total_num_scenarios(scenario_dict: ScenarioDict, limit_total_scenarios: Union[int, float], randomize: bool) -> ScenarioDict:
    """
    ...
    if isinstance(limit_total_scenarios, int):
        assert limit_total_scenarios > 0, 'Number of samples kept should be more than 0 in order to not have an empty cache.'
        num_nodes = int(os.environ.get('NUM_NODES', 1))
        required_num_scenarios = math.ceil(limit_total_scenarios / num_nodes)
