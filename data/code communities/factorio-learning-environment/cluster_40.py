...
class LuaScriptManager:
    ...
    def load_tool_into_game(self, name):
        tool_dirs = {f'agent/{name}', f'admin/{name}', f'agent\\{name}', f'admin\\{name}'}
                ...
                try:
                    for i in range(instance.num_agents):
                        ...
                        if directory_name == 'admin':
                            setattr(instance.namespaces[i], f'_{tool_name.lower()}', wrapped_instance)
                        else:
                            setattr(instance.namespaces[i], tool_name.lower(), wrapped_instance)
                except Exception as e:
