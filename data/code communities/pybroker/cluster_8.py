...
def assert_order(order, date, symbol, type, limit_price, fill_price, shares, fees):
...
def assert_trade(trade, type, symbol, entry_date, exit_date, entry, exit, shares, pnl, return_pct, agg_pnl, bars, pnl_per_bar, stop_type, mae, mfe):
