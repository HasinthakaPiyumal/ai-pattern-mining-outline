...
class TestDefaultChunkingService(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_extract(self):
        ...
        documents = [doc1, doc2]
        with patch.object(self.chunking_service, '_extract_chunks', return_value=[MockChunk(id=THash(xxhash.xxh3_64_intdigest(doc1.data) // 2), content=doc1.data, metadata=doc1.metadata)]) as mock_extract_chunks:
