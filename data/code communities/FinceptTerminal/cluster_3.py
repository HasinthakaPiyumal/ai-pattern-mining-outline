...
def get_all_tickers(ticker: Optional[str]=None, type: Optional[str]=None, market: Optional[str]=None, exchange: Optional[str]=None, cusip: Optional[str]=None, cik: Optional[str]=None, date: Optional[str]=None, search: Optional[str]=None, active: Optional[bool]=None, ticker_gte: Optional[str]=None, ticker_gt: Optional[str]=None, ticker_lte: Optional[str]=None, ticker_lt: Optional[str]=None, order: Optional[str]=None, limit: Optional[int]=None, sort: Optional[str]=None) -> Dict:
    """
    ...
    try:
        ...
        for ticker_data in result.get('results', []):
            ticker_info = {'ticker': ticker_data.get('ticker'), 'name': ticker_data.get('name'), 'market': ticker_data.get('market'), 'locale': ticker_data.get('locale'), 'type': ticker_data.get('type'), 'active': ticker_data.get('active'), 'currency_name': ticker_data.get('currency_name'), 'currency_symbol': ticker_data.get('currency_symbol'), 'base_currency_name': ticker_data.get('base_currency_name'), 'base_currency_symbol': ticker_data.get('base_currency_symbol'), 'primary_exchange': ticker_data.get('primary_exchange'), 'cik': ticker_data.get('cik'), 'composite_figi': ticker_data.get('composite_figi'), 'share_class_figi': ticker_data.get('share_class_figi'), 'last_updated_utc': ticker_data.get('last_updated_utc'), 'delisted_utc': ticker_data.get('delisted_utc')}
            tickers.append(ticker_info)
        return {'success': True, 'count': result.get('count', len(tickers)), 'tickers': tickers, 'next_url': result.get('next_url'), 'request_id': result.get('request_id'), 'status': result.get('status')}
...
def get_ticker_details(ticker: str, date: Optional[str]=None) -> Dict:
    ...
    try:
        ...
        address = {'address1': address_info.get('address1'), 'city': address_info.get('city'), 'state': address_info.get('state'), 'postal_code': address_info.get('postal_code')} if address_info else {}
        branding_info = ticker_data.get('branding', {})
        branding = {'icon_url': branding_info.get('icon_url'), 'logo_url': branding_info.get('logo_url')} if branding_info else {}
        ticker_details = {'ticker': ticker_data.get('ticker'), 'name': ticker_data.get('name'), 'description': ticker_data.get('description'), 'market': ticker_data.get('market'), 'locale': ticker_data.get('locale'), 'type': ticker_data.get('type'), 'active': ticker_data.get('active'), 'currency_name': ticker_data.get('currency_name'), 'primary_exchange': ticker_data.get('primary_exchange'), 'cik': ticker_data.get('cik'), 'composite_figi': ticker_data.get('composite_figi'), 'share_class_figi': ticker_data.get('share_class_figi'), 'market_cap': ticker_data.get('market_cap'), 'homepage_url': ticker_data.get('homepage_url'), 'phone_number': ticker_data.get('phone_number'), 'list_date': ticker_data.get('list_date'), 'delisted_utc': ticker_data.get('delisted_utc'), 'ticker_root': ticker_data.get('ticker_root'), 'ticker_suffix': ticker_data.get('ticker_suffix'), 'round_lot': ticker_data.get('round_lot'), 'share_class_shares_outstanding': ticker_data.get('share_class_shares_outstanding'), 'weighted_shares_outstanding': ticker_data.get('weighted_shares_outstanding'), 'total_employees': ticker_data.get('total_employees'), 'sic_code': ticker_data.get('sic_code'), 'sic_description': ticker_data.get('sic_description'), 'address': address, 'branding': branding}
        return {'success': True, 'ticker_details': ticker_details, 'request_id': result.get('request_id'), 'status': result.get('status')}
    except Exception as e:
...
def get_ticker_types(asset_class: Optional[str]=None, locale: Optional[str]=None) -> Dict:
    ...
    try:
        ...
        for type_data in result.get('results', []):
            type_info = {'code': type_data.get('code'), 'description': type_data.get('description'), 'asset_class': type_data.get('asset_class'), 'locale': type_data.get('locale')}
            ticker_types.append(type_info)
        return {'success': True, 'count': result.get('count', len(ticker_types)), 'ticker_types': ticker_types, 'request_id': result.get('request_id'), 'status': result.get('status')}
    except Exception as e:
...
def get_related_tickers(ticker: str) -> Dict:
    ...
    try:
        ...
        return {'success': True, 'ticker': ticker, 'related_tickers': related_tickers, 'count': len(related_tickers), 'request_id': result.get('request_id'), 'status': result.get('status')}
    except Exception as e:
        return {'error': str(e), 'function': 'get_related_tickers', 'ticker': ticker}

def get_news(ticker: Optional[str]=None, published_utc: Optional[str]=None, ticker_gte: Optional[str]=None, ticker_gt: Optional[str]=None, ticker_lte: Optional[str]=None, ticker_lt: Optional[str]=None, published_utc_gte: Optional[str]=None, published_utc_gt: Optional[str]=None, published_utc_lte: Optional[str]=None, published_utc_lt: Optional[str]=None, order: Optional[str]=None, limit: Optional[int]=None, sort: Optional[str]=None) -> Dict:
    """
    ...
    try:
        ...
        for article in result.get('results', []):
            ...
            publisher = {'name': publisher_info.get('name'), 'homepage_url': publisher_info.get('homepage_url'), 'logo_url': publisher_info.get('logo_url'), 'favicon_url': publisher_info.get('favicon_url')} if publisher_info else {}
            insights_list = []
            for insight in article.get('insights', []):
                insight_data = {'ticker': insight.get('ticker'), 'sentiment': insight.get('sentiment'), 'sentiment_reasoning': insight.get('sentiment_reasoning')}
                insights_list.append(insight_data)
            article_data = {'id': article.get('id'), 'title': article.get('title'), 'description': article.get('description'), 'author': article.get('author'), 'published_utc': article.get('published_utc'), 'article_url': article.get('article_url'), 'amp_url': article.get('amp_url'), 'image_url': article.get('image_url'), 'keywords': article.get('keywords', []), 'tickers': article.get('tickers', []), 'publisher': publisher, 'insights': insights_list}
            news_articles.append(article_data)
        return {'success': True, 'count': result.get('count', len(news_articles)), 'news_articles': news_articles, 'next_url': result.get('next_url'), 'request_id': result.get('request_id'), 'status': result.get('status')}
    except Exception as e:
        return {'error': str(e), 'function': 'get_news'}

def get_ipos(ticker: Optional[str]=None, us_code: Optional[str]=None, isin: Optional[str]=None, listing_date: Optional[str]=None, ipo_status: Optional[str]=None, listing_date_gte: Optional[str]=None, listing_date_gt: Optional[str]=None, listing_date_lte: Optional[str]=None, listing_date_lt: Optional[str]=None, order: Optional[str]=None, limit: Optional[int]=None, sort: Optional[str]=None) -> Dict:
    """
    ...
    try:
        ...
        for ipo_data in result.get('results', []):
            ipo_info = {'ticker': ipo_data.get('ticker'), 'issuer_name': ipo_data.get('issuer_name'), 'security_description': ipo_data.get('security_description'), 'security_type': ipo_data.get('security_type'), 'currency_code': ipo_data.get('currency_code'), 'primary_exchange': ipo_data.get('primary_exchange'), 'ipo_status': ipo_data.get('ipo_status'), 'announced_date': ipo_data.get('announced_date'), 'listing_date': ipo_data.get('listing_date'), 'issue_start_date': ipo_data.get('issue_start_date'), 'issue_end_date': ipo_data.get('issue_end_date'), 'last_updated': ipo_data.get('last_updated'), 'lowest_offer_price': ipo_data.get('lowest_offer_price'), 'highest_offer_price': ipo_data.get('highest_offer_price'), 'final_issue_price': ipo_data.get('final_issue_price'), 'min_shares_offered': ipo_data.get('min_shares_offered'), 'max_shares_offered': ipo_data.get('max_shares_offered'), 'shares_outstanding': ipo_data.get('shares_outstanding'), 'lot_size': ipo_data.get('lot_size'), 'total_offer_size': ipo_data.get('total_offer_size'), 'us_code': ipo_data.get('us_code'), 'isin': ipo_data.get('isin')}
            ipos.append(ipo_info)
        return {'success': True, 'count': len(ipos), 'ipos': ipos, 'next_url': result.get('next_url'), 'request_id': result.get('request_id'), 'status': result.get('status')}
    except Exception as e:
        return {'error': str(e), 'function': 'get_ipos'}

def get_splits(ticker: Optional[str]=None, execution_date: Optional[str]=None, reverse_split: Optional[bool]=None, ticker_gte: Optional[str]=None, ticker_gt: Optional[str]=None, ticker_lte: Optional[str]=None, ticker_lt: Optional[str]=None, execution_date_gte: Optional[str]=None, execution_date_gt: Optional[str]=None, execution_date_lte: Optional[str]=None, execution_date_lt: Optional[str]=None, order: Optional[str]=None, limit: Optional[int]=None, sort: Optional[str]=None) -> Dict:
    """
    ...
    try:
        ...
        for split_data in result.get('results', []):
            split_info = {'id': split_data.get('id'), 'ticker': split_data.get('ticker'), 'execution_date': split_data.get('execution_date'), 'split_from': split_data.get('split_from'), 'split_to': split_data.get('split_to'), 'split_ratio': f'{split_data.get('split_to', 1)}-for-{split_data.get('split_from', 1)}', 'reverse_split': split_data.get('split_from', 0) > split_data.get('split_to', 0)}
            splits.append(split_info)
        return {'success': True, 'count': len(splits), 'splits': splits, 'next_url': result.get('next_url'), 'request_id': result.get('request_id'), 'status': result.get('status')}
    except Exception as e:
        return {'error': str(e), 'function': 'get_splits'}

def get_dividends(ticker: Optional[str]=None, ex_dividend_date: Optional[str]=None, record_date: Optional[str]=None, declaration_date: Optional[str]=None, pay_date: Optional[str]=None, frequency: Optional[int]=None, cash_amount: Optional[float]=None, dividend_type: Optional[str]=None, ticker_gte: Optional[str]=None, ticker_gt: Optional[str]=None, ticker_lte: Optional[str]=None, ticker_lt: Optional[str]=None, ex_dividend_date_gte: Optional[str]=None, ex_dividend_date_gt: Optional[str]=None, ex_dividend_date_lte: Optional[str]=None, ex_dividend_date_lt: Optional[str]=None, record_date_gte: Optional[str]=None, record_date_gt: Optional[str]=None, record_date_lte: Optional[str]=None, record_date_lt: Optional[str]=None, declaration_date_gte: Optional[str]=None, declaration_date_gt: Optional[str]=None, declaration_date_lte: Optional[str]=None, declaration_date_lt: Optional[str]=None, pay_date_gte: Optional[str]=None, pay_date_gt: Optional[str]=None, pay_date_lte: Optional[str]=None, pay_date_lt: Optional[str]=None, cash_amount_gte: Optional[float]=None, cash_amount_gt: Optional[float]=None, cash_amount_lte: Optional[float]=None, cash_amount_lt: Optional[float]=None, order: Optional[str]=None, limit: Optional[int]=None, sort: Optional[str]=None) -> Dict:
    """
    ...
    try:
        ...
        for dividend_data in result.get('results', []):
            dividend_info = {'id': dividend_data.get('id'), 'ticker': dividend_data.get('ticker'), 'ex_dividend_date': dividend_data.get('ex_dividend_date'), 'record_date': dividend_data.get('record_date'), 'declaration_date': dividend_data.get('declaration_date'), 'pay_date': dividend_data.get('pay_date'), 'cash_amount': dividend_data.get('cash_amount'), 'currency': dividend_data.get('currency'), 'frequency': dividend_data.get('frequency'), 'dividend_type': dividend_data.get('dividend_type'), 'frequency_description': _get_frequency_description(dividend_data.get('frequency')), 'dividend_type_description': _get_dividend_type_description(dividend_data.get('dividend_type'))}
            dividends.append(dividend_info)
        return {'success': True, 'count': len(dividends), 'dividends': dividends, 'next_url': result.get('next_url'), 'request_id': result.get('request_id'), 'status': result.get('status')}
    except Exception as e:
...
def get_ticker_events(identifier: str, types: Optional[str]=None) -> Dict:
    ...
    try:
        ...
        for event_data in results_data.get('events', []):
            ...
            event_info = {'date': event_data.get('date'), 'type': event_data.get('type'), 'ticker_change': {'ticker': ticker_change.get('ticker')} if ticker_change else None}
            events.append(event_info)
        ticker_events_data = {'identifier': identifier, 'name': results_data.get('name'), 'events': events, 'event_count': len(events)}
        return {'success': True, 'ticker_events': ticker_events_data, 'request_id': result.get('request_id'), 'status': result.get('status')}
    except Exception as e:
...
def get_exchanges(asset_class: Optional[str]=None, locale: Optional[str]=None) -> Dict:
    ...
    try:
        ...
        for exchange_data in result.get('results', []):
            exchange_info = {'id': exchange_data.get('id'), 'name': exchange_data.get('name'), 'acronym': exchange_data.get('acronym'), 'mic': exchange_data.get('mic'), 'operating_mic': exchange_data.get('operating_mic'), 'participant_id': exchange_data.get('participant_id'), 'type': exchange_data.get('type'), 'asset_class': exchange_data.get('asset_class'), 'locale': exchange_data.get('locale'), 'url': exchange_data.get('url')}
            exchanges.append(exchange_info)
        return {'success': True, 'count': result.get('count', len(exchanges)), 'exchanges': exchanges, 'request_id': result.get('request_id'), 'status': result.get('status')}
    except Exception as e:
...
def get_market_holidays() -> Dict:
    ...
    try:
        ...
        for holiday_data in result:
            holiday_info = {'date': holiday_data.get('date'), 'exchange': holiday_data.get('exchange'), 'name': holiday_data.get('name'), 'status': holiday_data.get('status'), 'open': holiday_data.get('open'), 'close': holiday_data.get('close')}
            holidays.append(holiday_info)
        return {'success': True, 'count': len(holidays), 'market_holidays': holidays, 'status': 'OK'}
    except Exception as e:
...
def get_market_status() -> Dict:
    ...
    try:
        ...
        if 'error' in result:
            return result
        market_status_data = {'server_time': result.get('serverTime'), 'market': result.get('market'), 'after_hours': result.get('afterHours'), 'early_hours': result.get('earlyHours'), 'exchanges': result.get('exchanges', {}), 'currencies': result.get('currencies', {}), 'indices_groups': result.get('indicesGroups', {})}
        return {'success': True, 'market_status': market_status_data, 'status': 'OK'}
    except Exception as e:
        return {'error': str(e), 'function': 'get_market_status'}

def get_condition_codes(asset_class: Optional[str]=None, data_type: Optional[str]=None, id: Optional[int]=None, sip: Optional[str]=None, order: Optional[str]=None, limit: Optional[int]=None, sort: Optional[str]=None) -> Dict:
    """
    ...
    try:
        ...
        for condition_data in result.get('results', []):
            condition_info = {'id': condition_data.get('id'), 'name': condition_data.get('name'), 'abbreviation': condition_data.get('abbreviation'), 'description': condition_data.get('description'), 'type': condition_data.get('type'), 'asset_class': condition_data.get('asset_class'), 'data_types': condition_data.get('data_types', []), 'exchange': condition_data.get('exchange'), 'legacy': condition_data.get('legacy'), 'sip_mapping': condition_data.get('sip_mapping', {}), 'update_rules': condition_data.get('update_rules', {})}
            conditions.append(condition_info)
        return {'success': True, 'count': result.get('count', len(conditions)), 'condition_codes': conditions, 'next_url': result.get('next_url'), 'request_id': result.get('request_id'), 'status': result.get('status')}
    except Exception as e:
...
def get_single_ticker_snapshot(ticker: str) -> Dict:
    ...
    try:
        ...
        snapshot_data = {'ticker': ticker_data.get('ticker'), 'updated': ticker_data.get('updated'), 'todays_change': ticker_data.get('todaysChange'), 'todays_change_perc': ticker_data.get('todaysChangePerc'), 'day': {'open': ticker_data.get('day', {}).get('o'), 'high': ticker_data.get('day', {}).get('h'), 'low': ticker_data.get('day', {}).get('l'), 'close': ticker_data.get('day', {}).get('c'), 'volume': ticker_data.get('day', {}).get('v'), 'vwap': ticker_data.get('day', {}).get('vw')}, 'prev_day': {'open': ticker_data.get('prevDay', {}).get('o'), 'high': ticker_data.get('prevDay', {}).get('h'), 'low': ticker_data.get('prevDay', {}).get('l'), 'close': ticker_data.get('prevDay', {}).get('c'), 'volume': ticker_data.get('prevDay', {}).get('v'), 'vwap': ticker_data.get('prevDay', {}).get('vw')}, 'last_trade': {'price': ticker_data.get('lastTrade', {}).get('p'), 'size': ticker_data.get('lastTrade', {}).get('s'), 'timestamp': ticker_data.get('lastTrade', {}).get('t'), 'exchange': ticker_data.get('lastTrade', {}).get('x'), 'conditions': ticker_data.get('lastTrade', {}).get('c')}, 'last_quote': {'bid_price': ticker_data.get('lastQuote', {}).get('P'), 'bid_size': ticker_data.get('lastQuote', {}).get('S'), 'ask_price': ticker_data.get('lastQuote', {}).get('p'), 'ask_size': ticker_data.get('lastQuote', {}).get('s'), 'timestamp': ticker_data.get('lastQuote', {}).get('t'), 'conditions': ticker_data.get('lastQuote', {}).get('c')}, 'minute': {'open': ticker_data.get('min', {}).get('o'), 'high': ticker_data.get('min', {}).get('h'), 'low': ticker_data.get('min', {}).get('l'), 'close': ticker_data.get('min', {}).get('c'), 'volume': ticker_data.get('min', {}).get('v'), 'vwap': ticker_data.get('min', {}).get('vw'), 'num_trades': ticker_data.get('min', {}).get('n'), 'timestamp': ticker_data.get('min', {}).get('t')}}
        return {'success': True, 'snapshot': snapshot_data, 'request_id': result.get('request_id'), 'status': result.get('status')}
    except Exception as e:
...
def get_full_market_snapshot(tickers: Optional[List[str]]=None, include_otc: bool=False) -> Dict:
    ...
    try:
        ...
        if 'error' in result:
            return result
        snapshot_data = {'status': result.get('status'), 'count': result.get('count', 0), 'request_id': result.get('requestId'), 'tickers': result.get('tickers', [])}
        ...
        if tickers_list:
            ...
            snapshot_data['summary'] = {'total_volume': total_volume, 'advancers': advancers, 'decliners': decliners, 'unchanged': unchanged, 'total_processed': len(tickers_list)}
        return snapshot_data
    except Exception as e:
        return {'error': f'Failed to get full market snapshot: {str(e)}'}

def get_unified_snapshot(ticker: Optional[str]=None, type: Optional[str]=None, ticker_gte: Optional[str]=None, ticker_gt: Optional[str]=None, ticker_lte: Optional[str]=None, ticker_lt: Optional[str]=None, ticker_any_of: Optional[str]=None, order: Optional[str]=None, limit: Optional[int]=None, sort: Optional[str]=None) -> Dict:
    """
    ...
    try:
        ...
        for snapshot_data in result.get('results', []):
            snapshot_info = {'ticker': snapshot_data.get('ticker'), 'name': snapshot_data.get('name'), 'type': snapshot_data.get('type'), 'market_status': snapshot_data.get('market_status'), 'timeframe': snapshot_data.get('timeframe'), 'last_updated': snapshot_data.get('last_updated')}
            if snapshot_data.get('error'):
                snapshot_info['error'] = {'code': snapshot_data.get('error'), 'message': snapshot_data.get('message')}
            if snapshot_data.get('fmv') is not None:
                snapshot_info['fair_market_value'] = {'value': snapshot_data.get('fmv'), 'last_updated': snapshot_data.get('fmv_last_updated')}
            session_data = snapshot_data.get('session')
            if session_data:
                snapshot_info['session'] = {'open': session_data.get('open'), 'high': session_data.get('high'), 'low': session_data.get('low'), 'close': session_data.get('close'), 'volume': session_data.get('volume'), 'previous_close': session_data.get('previous_close'), 'change': session_data.get('change'), 'change_percent': session_data.get('change_percent'), 'early_trading_change': session_data.get('early_trading_change'), 'early_trading_change_percent': session_data.get('early_trading_change_percent'), 'regular_trading_change': session_data.get('regular_trading_change'), 'regular_trading_change_percent': session_data.get('regular_trading_change_percent'), 'late_trading_change': session_data.get('late_trading_change'), 'late_trading_change_percent': session_data.get('late_trading_change_percent')}
            last_quote = snapshot_data.get('last_quote')
            if last_quote:
                snapshot_info['last_quote'] = {'bid': last_quote.get('bid'), 'bid_size': last_quote.get('bid_size'), 'bid_exchange': last_quote.get('bid_exchange'), 'ask': last_quote.get('ask'), 'ask_size': last_quote.get('ask_size'), 'ask_exchange': last_quote.get('ask_exchange'), 'midpoint': last_quote.get('midpoint'), 'last_updated': last_quote.get('last_updated'), 'timeframe': last_quote.get('timeframe')}
            last_trade = snapshot_data.get('last_trade')
            if last_trade:
                snapshot_info['last_trade'] = {'price': last_trade.get('price'), 'size': last_trade.get('size'), 'exchange': last_trade.get('exchange'), 'conditions': last_trade.get('conditions'), 'last_updated': last_trade.get('last_updated'), 'sip_timestamp': last_trade.get('sip_timestamp'), 'timeframe': last_trade.get('timeframe')}
            asset_type = snapshot_data.get('type')
            if asset_type == 'stocks':
                last_minute = snapshot_data.get('last_minute')
                if last_minute:
                    snapshot_info['last_minute'] = {'open': last_minute.get('open'), 'high': last_minute.get('high'), 'low': last_minute.get('low'), 'close': last_minute.get('close'), 'volume': last_minute.get('volume'), 'transactions': last_minute.get('transactions'), 'vwap': last_minute.get('vwap')}
            elif asset_type == 'options':
                details = snapshot_data.get('details', {})
                if details:
                    snapshot_info['option_details'] = {'contract_type': details.get('contract_type'), 'exercise_style': details.get('exercise_style'), 'expiration_date': details.get('expiration_date'), 'strike_price': details.get('strike_price'), 'shares_per_contract': details.get('shares_per_contract'), 'underlying_ticker': details.get('underlying_ticker')}
                greeks = snapshot_data.get('greeks', {})
                if greeks:
                    snapshot_info['greeks'] = {'delta': greeks.get('delta'), 'gamma': greeks.get('gamma'), 'theta': greeks.get('theta'), 'vega': greeks.get('vega')}
                ...
                if underlying:
                    snapshot_info['underlying_asset'] = {'ticker': underlying.get('ticker'), 'price': underlying.get('price'), 'change_to_break_even': underlying.get('change_to_break_even'), 'last_updated': underlying.get('last_updated'), 'timeframe': underlying.get('timeframe')}
        ...
        return {'success': True, 'count': len(snapshots), 'snapshots': snapshots, 'summary': {'asset_types': asset_type_counts, 'successful_requests': successful_requests, 'failed_requests': failed_requests, 'total_processed': len(snapshots)}, 'next_url': result.get('next_url'), 'request_id': result.get('request_id'), 'status': result.get('status')}
    except Exception as e:
...
def get_top_market_movers(direction: str, include_otc: bool=False) -> Dict:
    ...
    try:
        ...
        for ticker_data in tickers_list:
            enhanced_ticker = {'ticker': ticker_data.get('ticker'), 'updated': ticker_data.get('updated'), 'todays_change': ticker_data.get('todaysChange'), 'todays_change_perc': ticker_data.get('todaysChangePerc'), 'day': {'open': ticker_data.get('day', {}).get('o'), 'high': ticker_data.get('day', {}).get('h'), 'low': ticker_data.get('day', {}).get('l'), 'close': ticker_data.get('day', {}).get('c'), 'volume': ticker_data.get('day', {}).get('v'), 'vwap': ticker_data.get('day', {}).get('vw')}, 'prev_day': {'open': ticker_data.get('prevDay', {}).get('o'), 'high': ticker_data.get('prevDay', {}).get('h'), 'low': ticker_data.get('prevDay', {}).get('l'), 'close': ticker_data.get('prevDay', {}).get('c'), 'volume': ticker_data.get('prevDay', {}).get('v'), 'vwap': ticker_data.get('prevDay', {}).get('vw')}, 'last_trade': {'price': ticker_data.get('lastTrade', {}).get('p'), 'size': ticker_data.get('lastTrade', {}).get('s'), 'timestamp': ticker_data.get('lastTrade', {}).get('t'), 'exchange': ticker_data.get('lastTrade', {}).get('x'), 'conditions': ticker_data.get('lastTrade', {}).get('c')}, 'last_quote': {'bid_price': ticker_data.get('lastQuote', {}).get('P'), 'bid_size': ticker_data.get('lastQuote', {}).get('S'), 'ask_price': ticker_data.get('lastQuote', {}).get('p'), 'ask_size': ticker_data.get('lastQuote', {}).get('s'), 'timestamp': ticker_data.get('lastQuote', {}).get('t'), 'conditions': ticker_data.get('lastQuote', {}).get('c')}, 'minute': {'open': ticker_data.get('min', {}).get('o'), 'high': ticker_data.get('min', {}).get('h'), 'low': ticker_data.get('min', {}).get('l'), 'close': ticker_data.get('min', {}).get('c'), 'volume': ticker_data.get('min', {}).get('v'), 'vwap': ticker_data.get('min', {}).get('vw'), 'num_trades': ticker_data.get('min', {}).get('n'), 'timestamp': ticker_data.get('min', {}).get('t')}}
            ...
            enhanced_ticker['metrics'] = {'day_volume': day_volume, 'previous_close': prev_close, 'current_price': current_price, 'price_range': ticker_data.get('day', {}).get('h', 0) - ticker_data.get('day', {}).get('l', 0), 'spread': ticker_data.get('lastQuote', {}).get('p', 0) - ticker_data.get('lastQuote', {}).get('P', 0)}
            enhanced_ticker['rank'] = len(enhanced_tickers) + 1
        ...
        if enhanced_tickers:
            ...
            price_ranges = {'under_10': len([t for t in enhanced_tickers if t['metrics']['current_price'] < 10]), '10_to_50': len([t for t in enhanced_tickers if 10 <= t['metrics']['current_price'] < 50]), '50_to_100': len([t for t in enhanced_tickers if 50 <= t['metrics']['current_price'] < 100]), 'over_100': len([t for t in enhanced_tickers if t['metrics']['current_price'] >= 100])}
            summary = {'direction': direction.lower(), 'total_volume': total_volume, 'average_change_percent': round(avg_change, 2), 'biggest_mover': {'ticker': biggest_mover['ticker'], 'change_percent': biggest_mover['todays_change_perc']}, 'price_distribution': price_ranges, 'movers_count': len(enhanced_tickers), 'include_otc': include_otc}
        else:
            summary = {'direction': direction.lower(), 'movers_count': 0, 'include_otc': include_otc, 'message': f'No top {direction.lower()} found at this time'}
        return {'success': True, 'direction': direction.lower(), 'status': result.get('status'), 'tickers': enhanced_tickers, 'summary': summary, 'request_id': result.get('request_id')}
    except Exception as e:
        return {'error': f'Failed to get top market movers: {str(e)}'}

def get_trades(stock_ticker: str, timestamp: Optional[str]=None, timestamp_gte: Optional[str]=None, timestamp_gt: Optional[str]=None, timestamp_lte: Optional[str]=None, timestamp_lt: Optional[str]=None, order: Optional[str]=None, limit: Optional[int]=None, sort: Optional[str]=None) -> Dict:
    """
    ...
    try:
        ...
        for trade_data in result.get('results', []):
            trade_info = {'trade_id': trade_data.get('id'), 'ticker': stock_ticker, 'price': trade_data.get('price'), 'size': trade_data.get('size'), 'exchange': trade_data.get('exchange'), 'tape': trade_data.get('tape'), 'sequence_number': trade_data.get('sequence_number'), 'conditions': trade_data.get('conditions', []), 'correction': trade_data.get('correction'), 'trf_id': trade_data.get('trf_id'), 'participant_timestamp': trade_data.get('participant_timestamp'), 'sip_timestamp': trade_data.get('sip_timestamp'), 'trf_timestamp': trade_data.get('trf_timestamp')}
            trade_volume = trade_data.get('size', 0)
            trade_price = trade_data.get('price', 0)
            trade_value = trade_volume * trade_price
            trade_info['metrics'] = {'trade_volume': trade_volume, 'trade_value': trade_value, 'trade_conditions_count': len(trade_data.get('conditions', [])), 'exchange_id': trade_data.get('exchange'), 'tape_id': trade_data.get('tape')}
        ...
        if trades:
            ...
            if timestamps:
                ...
                time_range_seconds = time_range_ns / 1000000000 if time_range_ns > 0 else 0
            else:
                start_time = None
                end_time = None
                time_range_seconds = 0
            summary = {'ticker': stock_ticker, 'trade_count': len(trades), 'total_volume': total_volume, 'total_value': total_value, 'average_price': round(avg_price, 4), 'average_size': round(avg_size, 2), 'min_price': min_price, 'max_price': max_price, 'price_range': round(price_range, 4), 'time_range_seconds': round(time_range_seconds, 3), 'start_time': start_time, 'end_time': end_time, 'exchange_distribution': exchange_counts, 'tape_distribution': tape_counts, 'most_active_exchange': max(exchange_counts.items(), key=lambda x: x[1])[0] if exchange_counts else None}
        else:
            summary = {'ticker': stock_ticker, 'trade_count': 0, 'message': f'No trades found for {stock_ticker} with specified criteria'}
        return {'success': True, 'ticker': stock_ticker, 'trades': trades, 'summary': summary, 'next_url': result.get('next_url'), 'request_id': result.get('request_id'), 'status': result.get('status')}
    except Exception as e:
...
def get_last_trade(stocks_ticker: str) -> Dict:
    ...
    try:
        ...
        last_trade = {'ticker': trade_data.get('T'), 'trade_id': trade_data.get('i'), 'price': trade_data.get('p'), 'size': trade_data.get('s'), 'exchange_id': trade_data.get('x'), 'tape_id': trade_data.get('z'), 'sequence_number': trade_data.get('q'), 'conditions': trade_data.get('c', []), 'correction_indicator': trade_data.get('e'), 'trf_id': trade_data.get('r'), 'sip_timestamp': trade_data.get('t'), 'trf_timestamp': trade_data.get('f'), 'participant_timestamp': trade_data.get('y')}
        tape_map = {1: 'A (NYSE)', 2: 'B (NYSE ARCA)', 3: 'C (NASDAQ)'}
        ...
        last_trade['metrics'] = {'trade_value': trade_value, 'trade_conditions_count': len(trade_data.get('c', [])), 'exchange_id': trade_data.get('x'), 'tape_id': trade_data.get('z'), 'trf_id': trade_data.get('r')}
        ...
        if sip_timestamp and participant_timestamp:
            ...
            timestamp_analysis['sip_to_participant_latency_ms'] = latency_sip_participant / 1000000
        if trf_timestamp and sip_timestamp:
            ...
            timestamp_analysis['trf_to_sip_latency_ms'] = latency_trf_sip / 1000000
        if participant_timestamp and trf_timestamp:
            ...
            timestamp_analysis['participant_to_trf_latency_ms'] = latency_participant_trf / 1000000
        last_trade['timestamp_analysis'] = timestamp_analysis
        conditions = trade_data.get('c', [])
        if conditions:
            last_trade['conditions_info'] = {'condition_codes': conditions, 'conditions_count': len(conditions), 'has_conditions': True}
        else:
            last_trade['conditions_info'] = {'condition_codes': [], 'conditions_count': 0, 'has_conditions': False}
        last_trade['exchange_info'] = {'exchange_id': trade_data.get('x'), 'is_regular_hours': True, 'tape_id': tape_id, 'tape_description': last_trade.get('tape_description')}
        if sip_timestamp:
            try:
                import datetime
                trade_time = datetime.datetime.fromtimestamp(sip_timestamp / 1000000000)
                last_trade['trade_time_formatted'] = trade_time.strftime('%Y-%m-%d %H:%M:%S.%f')[:-3]
                last_trade['trade_date'] = trade_time.strftime('%Y-%m-%d')
                last_trade['trade_time'] = trade_time.strftime('%H:%M:%S')
            except (ValueError, OSError):
                pass
        return {'success': True, 'ticker': stocks_ticker, 'last_trade': last_trade, 'request_id': result.get('request_id'), 'status': result.get('status')}
    except Exception as e:
        return {'error': f'Failed to get last trade for {stocks_ticker}: {str(e)}'}

def get_quotes(stock_ticker: str, timestamp: Optional[str]=None, timestamp_gte: Optional[str]=None, timestamp_gt: Optional[str]=None, timestamp_lte: Optional[str]=None, timestamp_lt: Optional[str]=None, order: Optional[str]=None, limit: Optional[int]=None, sort: Optional[str]=None) -> Dict:
    """
    ...
    try:
        ...
        for quote_data in result.get('results', []):
            quote_info = {'ticker': stock_ticker, 'bid_price': quote_data.get('bid_price'), 'bid_size': quote_data.get('bid_size'), 'bid_exchange': quote_data.get('bid_exchange'), 'ask_price': quote_data.get('ask_price'), 'ask_size': quote_data.get('ask_size'), 'ask_exchange': quote_data.get('ask_exchange'), 'tape': quote_data.get('tape'), 'sequence_number': quote_data.get('sequence_number'), 'conditions': quote_data.get('conditions', []), 'indicators': quote_data.get('indicators', []), 'participant_timestamp': quote_data.get('participant_timestamp'), 'sip_timestamp': quote_data.get('sip_timestamp'), 'trf_timestamp': quote_data.get('trf_timestamp')}
            ...
            quote_info['nbbo_metrics'] = {'spread': spread, 'spread_percentage': round(spread_percentage, 4), 'mid_price': mid_price, 'bid_price': bid_price, 'ask_price': ask_price, 'bid_size_round_lots': bid_size, 'ask_size_round_lots': ask_size, 'bid_size_shares': actual_bid_size, 'ask_size_shares': actual_ask_size, 'total_liquidity_shares': actual_bid_size + actual_ask_size, 'has_bid': bid_price > 0, 'has_ask': ask_price > 0, 'has_nbbo': bid_price > 0 and ask_price > 0}
            quote_info['exchange_info'] = {'bid_exchange_id': quote_data.get('bid_exchange'), 'ask_exchange_id': quote_data.get('ask_exchange'), 'tape_id': quote_data.get('tape'), 'same_exchange': quote_data.get('bid_exchange') == quote_data.get('ask_exchange')}
            tape_map = {1: 'A (NYSE)', 2: 'B (NYSE ARCA)', 3: 'C (NASDAQ)'}
            ...
            quote_info['quote_conditions'] = {'condition_codes': conditions, 'indicators': indicators, 'conditions_count': len(conditions), 'indicators_count': len(indicators), 'has_conditions': len(conditions) > 0, 'has_indicators': len(indicators) > 0}
        ...
        if quotes:
            ...
            if timestamps:
                ...
                end_time = None
                time_range_seconds = 0
            summary = {'ticker': stock_ticker, 'quote_count': len(quotes), 'time_range_seconds': round(time_range_seconds, 3), 'start_time': start_time, 'end_time': end_time, 'spread_analysis': {'average_spread': round(avg_spread, 4), 'min_spread': min_spread, 'max_spread': max_spread}, 'liquidity_analysis': {'total_liquidity_shares': total_liquidity, 'average_liquidity_shares': round(avg_liquidity, 2)}, 'price_analysis': {'average_mid_price': round(avg_mid_price, 4)}, 'nbbo_completeness': {'complete_nbbo': nbbo_complete, 'bid_only': bid_only, 'ask_only': ask_only, 'nbbo_completion_rate': round(nbbo_complete / len(quotes) * 100, 2)}, 'exchange_distribution': {'bid_exchanges': bid_exchanges, 'ask_exchanges': ask_exchanges, 'most_active_bid_exchange': max(bid_exchanges.items(), key=lambda x: x[1])[0] if bid_exchanges else None, 'most_active_ask_exchange': max(ask_exchanges.items(), key=lambda x: x[1])[0] if ask_exchanges else None}}
        else:
            summary = {'ticker': stock_ticker, 'quote_count': 0, 'message': f'No quotes found for {stock_ticker} with specified criteria'}
        return {'success': True, 'ticker': stock_ticker, 'quotes': quotes, 'summary': summary, 'next_url': result.get('next_url'), 'request_id': result.get('request_id'), 'status': result.get('status')}
    except Exception as e:
...
def get_last_quote(stocks_ticker: str) -> Dict:
    ...
    try:
        ...
        last_quote = {'ticker': quote_data.get('T'), 'bid_price': bid_price, 'ask_price': ask_price, 'bid_size': bid_size, 'ask_size': ask_size, 'bid_exchange_id': quote_data.get('x'), 'ask_exchange_id': quote_data.get('X'), 'tape_id': quote_data.get('z'), 'sequence_number': quote_data.get('q'), 'conditions': quote_data.get('c', []), 'indicators': quote_data.get('i', []), 'sip_timestamp': quote_data.get('t'), 'trf_timestamp': quote_data.get('f'), 'participant_timestamp': quote_data.get('y')}
        tape_map = {1: 'A (NYSE)', 2: 'B (NYSE ARCA)', 3: 'C (NASDAQ)'}
        ...
        actual_bid_size = bid_size * 100
        actual_ask_size = ask_size * 100
        last_quote['nbbo_metrics'] = {'spread': spread, 'spread_percentage': round(spread_percentage, 4), 'mid_price': mid_price, 'bid_price': bid_price, 'ask_price': ask_price, 'bid_size_round_lots': bid_size, 'ask_size_round_lots': ask_size, 'bid_size_shares': actual_bid_size, 'ask_size_shares': actual_ask_size, 'total_liquidity_shares': actual_bid_size + actual_ask_size, 'has_bid': bid_price > 0, 'has_ask': ask_price > 0, 'has_nbbo': bid_price > 0 and ask_price > 0, 'spread_bps': round(spread_percentage * 100, 2)}
        last_quote['exchange_info'] = {'bid_exchange_id': quote_data.get('x'), 'ask_exchange_id': quote_data.get('X'), 'tape_id': tape_id, 'same_exchange': quote_data.get('x') == quote_data.get('X'), 'cross_exchange': quote_data.get('x') != quote_data.get('X')}
        ...
        last_quote['quote_conditions'] = {'condition_codes': conditions, 'indicators': indicators, 'conditions_count': len(conditions), 'indicators_count': len(indicators), 'has_conditions': len(conditions) > 0, 'has_indicators': len(indicators) > 0}
        if sip_timestamp:
            try:
                import datetime
                quote_time = datetime.datetime.fromtimestamp(sip_timestamp / 1000000000)
                last_quote['quote_time_formatted'] = quote_time.strftime('%Y-%m-%d %H:%M:%S.%f')[:-3]
        ...
        if last_quote['nbbo_metrics']['has_nbbo']:
            ...
            last_quote['liquidity_analysis'] = {'spread_quality': spread_quality, 'size_quality': size_quality, 'overall_liquidity': 'Excellent' if spread_quality == 'Tight' and size_quality == 'High' else 'Good' if spread_quality in ['Tight', 'Normal'] and size_quality in ['High', 'Normal'] else 'Fair'}
        return {'success': True, 'ticker': stocks_ticker, 'last_quote': last_quote, 'request_id': result.get('request_id'), 'status': result.get('status')}
    except Exception as e:
        return {'error': f'Failed to get last quote for {stocks_ticker}: {str(e)}'}

def get_sma(stock_ticker: str, timestamp: Optional[str]=None, timespan: Optional[str]=None, adjusted: Optional[bool]=None, window: Optional[int]=None, series_type: Optional[str]=None, expand_underlying: Optional[bool]=None, order: Optional[str]=None, limit: Optional[int]=None, timestamp_gte: Optional[str]=None, timestamp_gt: Optional[str]=None, timestamp_lte: Optional[str]=None, timestamp_lt: Optional[str]=None) -> Dict:
    """
    ...
    try:
        ...
        for sma_point in sma_values:
            point_info = {'timestamp': sma_point.get('timestamp'), 'sma_value': sma_point.get('value'), 'date': None}
            timestamp = sma_point.get('timestamp')
            if timestamp:
                try:
                    import datetime
                    if timestamp > 1000000000000000.0:
                        point_time = datetime.datetime.fromtimestamp(timestamp / 1000000000)
                    else:
        ...
        if underlying_data and expand_underlying:
            ...
            for agg in aggregates:
                agg_info = {'timestamp': agg.get('t'), 'open': agg.get('o'), 'high': agg.get('h'), 'low': agg.get('l'), 'close': agg.get('c'), 'volume': agg.get('v'), 'vwap': agg.get('vw'), 'transactions': agg.get('n'), 'date': None}
                timestamp = agg.get('t')
                if timestamp:
                    try:
                        import datetime
                        if timestamp > 1000000000000000.0:
                            agg_time = datetime.datetime.fromtimestamp(timestamp / 1000000000)
                        else:
        ...
        if processed_sma:
            ...
            if sma_values_list:
                sma_stats = {'count': len(sma_values_list), 'min_value': min(sma_values_list), 'max_value': max(sma_values_list), 'avg_value': sum(sma_values_list) / len(sma_values_list), 'latest_value': sma_values_list[-1] if sma_values_list else None, 'first_value': sma_values_list[0] if sma_values_list else None, 'total_change': sma_values_list[-1] - sma_values_list[0] if len(sma_values_list) > 1 else 0, 'percent_change': (sma_values_list[-1] - sma_values_list[0]) / sma_values_list[0] * 100 if len(sma_values_list) > 1 and sma_values_list[0] != 0 else 0}
            else:
                sma_stats = {'count': 0, 'message': 'No valid SMA values found'}
        else:
            sma_stats = {'count': 0, 'message': 'No SMA data found'}
        sma_response = {'ticker': stock_ticker, 'indicator_type': 'SMA', 'parameters': {'window': window, 'series_type': series_type, 'timespan': timespan, 'adjusted': adjusted}, 'sma_values': processed_sma, 'statistics': sma_stats, 'underlying_url': underlying_data.get('url') if underlying_data else None}
        if expand_underlying and underlying_aggregates:
            sma_response['underlying_aggregates'] = underlying_aggregates
        return {'success': True, 'sma_data': sma_response, 'next_url': result.get('next_url'), 'request_id': result.get('request_id'), 'status': result.get('status')}
    except Exception as e:
        return {'error': f'Failed to get SMA for {stock_ticker}: {str(e)}'}

def get_ema(stock_ticker: str, timestamp: Optional[str]=None, timespan: Optional[str]=None, adjusted: Optional[bool]=None, window: Optional[int]=None, series_type: Optional[str]=None, expand_underlying: Optional[bool]=None, order: Optional[str]=None, limit: Optional[int]=None, timestamp_gte: Optional[str]=None, timestamp_gt: Optional[str]=None, timestamp_lte: Optional[str]=None, timestamp_lt: Optional[str]=None) -> Dict:
    """
    ...
    try:
        ...
        for ema_point in ema_values:
            point_info = {'timestamp': ema_point.get('timestamp'), 'ema_value': ema_point.get('value'), 'date': None}
        ...
        if processed_ema:
            ...
            if ema_values_list:
                ema_stats = {'count': len(ema_values_list), 'min_value': min(ema_values_list), 'max_value': max(ema_values_list), 'avg_value': sum(ema_values_list) / len(ema_values_list), 'latest_value': ema_values_list[-1] if ema_values_list else None, 'first_value': ema_values_list[0] if ema_values_list else None, 'total_change': ema_values_list[-1] - ema_values_list[0] if len(ema_values_list) > 1 else 0, 'percent_change': (ema_values_list[-1] - ema_values_list[0]) / ema_values_list[0] * 100 if len(ema_values_list) > 1 and ema_values_list[0] != 0 else 0}
            else:
                ema_stats = {'count': 0, 'message': 'No valid EMA values found'}
        else:
            ema_stats = {'count': 0, 'message': 'No EMA data found'}
        ema_response = {'ticker': stock_ticker, 'indicator_type': 'EMA', 'parameters': {'window': window, 'series_type': series_type, 'timespan': timespan, 'adjusted': adjusted}, 'ema_values': processed_ema, 'statistics': ema_stats, 'underlying_url': underlying_data.get('url') if underlying_data else None}
        if expand_underlying and underlying_aggregates:
            ema_response['underlying_aggregates'] = underlying_aggregates
        return {'success': True, 'ema_data': ema_response, 'next_url': result.get('next_url'), 'request_id': result.get('request_id'), 'status': result.get('status')}
    except Exception as e:
        return {'error': f'Failed to get EMA for {stock_ticker}: {str(e)}'}

def get_macd(stock_ticker: str, timestamp: Optional[str]=None, timespan: Optional[str]=None, adjusted: Optional[bool]=None, short_window: Optional[int]=None, long_window: Optional[int]=None, signal_window: Optional[int]=None, series_type: Optional[str]=None, expand_underlying: Optional[bool]=None, order: Optional[str]=None, limit: Optional[int]=None, timestamp_gte: Optional[str]=None, timestamp_gt: Optional[str]=None, timestamp_lte: Optional[str]=None, timestamp_lt: Optional[str]=None) -> Dict:
    """
    ...
    try:
        ...
        for macd_point in macd_values:
            point_info = {'timestamp': macd_point.get('timestamp'), 'macd_value': macd_point.get('value'), 'signal_line': macd_point.get('signal'), 'histogram': macd_point.get('histogram'), 'date': None}
            ...
            if macd_val and signal_val:
                point_info['crossover_analysis'] = {'macd_above_signal': macd_val > signal_val, 'macd_below_signal': macd_val < signal_val, 'signal_crossover': abs(macd_val - signal_val) < 0.001, 'macd_signal_diff': macd_val - signal_val}
            else:
                point_info['crossover_analysis'] = {'macd_above_signal': None, 'macd_below_signal': None, 'signal_crossover': False, 'macd_signal_diff': None}
            point_info['zero_line_analysis'] = {'macd_above_zero': macd_val > 0, 'macd_below_zero': macd_val < 0, 'macd_near_zero': abs(macd_val) < 0.01}
            point_info['signal_strength'] = {'histogram_positive': histogram_val > 0, 'histogram_negative': histogram_val < 0, 'histogram_strength': abs(histogram_val)}
        ...
        if processed_macd:
            ...
            if macd_values_list:
                macd_stats = {'count': len(macd_values_list), 'min_value': min(macd_values_list), 'max_value': max(macd_values_list), 'avg_value': sum(macd_values_list) / len(macd_values_list), 'latest_value': macd_values_list[-1] if macd_values_list else None, 'first_value': macd_values_list[0] if macd_values_list else None, 'total_change': macd_values_list[-1] - macd_values_list[0] if len(macd_values_list) > 1 else 0, 'percent_change': (macd_values_list[-1] - macd_values_list[0]) / macd_values_list[0] * 100 if len(macd_values_list) > 1 and macd_values_list[0] != 0 else 0}
            else:
                macd_stats = {'count': 0, 'message': 'No valid MACD values found'}
            if signal_values_list:
                signal_stats = {'min_value': min(signal_values_list), 'max_value': max(signal_values_list), 'avg_value': sum(signal_values_list) / len(signal_values_list), 'latest_value': signal_values_list[-1] if signal_values_list else None, 'first_value': signal_values_list[0] if signal_values_list else None}
            else:
                signal_stats = {'message': 'No signal line data found'}
            if histogram_values_list:
                histogram_stats = {'min_value': min(histogram_values_list), 'max_value': max(histogram_values_list), 'avg_value': sum(histogram_values_list) / len(histogram_values_list), 'latest_value': histogram_values_list[-1] if histogram_values_list else None, 'positive_periods': sum((1 for h in histogram_values_list if h > 0)), 'negative_periods': sum((1 for h in histogram_values_list if h < 0)), 'zero_periods': sum((1 for h in histogram_values_list if abs(h) < 0.001))}
            else:
            ...
            crossover_stats = {'total_crossovers': len(crossovers), 'macd_above_signal_periods': macd_above_signal, 'macd_below_signal_periods': macd_below_signal, 'dominant_position': 'bullish' if macd_above_signal > macd_below_signal else 'bearish' if macd_below_signal > macd_above_signal else 'neutral'}
        else:
            macd_stats = {'count': 0, 'message': 'No MACD data found'}
            signal_stats = {'message': 'No signal line data found'}
            histogram_stats = {'message': 'No histogram data found'}
            crossover_stats = {'message': 'No crossover data found'}
        macd_response = {'ticker': stock_ticker, 'indicator_type': 'MACD', 'parameters': {'short_window': short_window, 'long_window': long_window, 'signal_window': signal_window, 'series_type': series_type, 'timespan': timespan, 'adjusted': adjusted}, 'macd_values': processed_macd, 'statistics': {'macd_stats': macd_stats, 'signal_stats': signal_stats, 'histogram_stats': histogram_stats, 'crossover_stats': crossover_stats}, 'underlying_url': underlying_data.get('url') if underlying_data else None}
        if expand_underlying and underlying_aggregates:
            macd_response['underlying_aggregates'] = underlying_aggregates
        return {'success': True, 'macd_data': macd_response, 'next_url': result.get('next_url'), 'request_id': result.get('request_id'), 'status': result.get('status')}
    except Exception as e:
        return {'error': f'Failed to get MACD for {stock_ticker}: {str(e)}'}

def get_rsi(stock_ticker: str, timestamp: Optional[str]=None, timespan: Optional[str]=None, adjusted: Optional[bool]=None, window: Optional[int]=None, series_type: Optional[str]=None, expand_underlying: Optional[bool]=None, order: Optional[str]=None, limit: Optional[int]=None, timestamp_gte: Optional[str]=None, timestamp_gt: Optional[str]=None, timestamp_lte: Optional[str]=None, timestamp_lt: Optional[str]=None) -> Dict:
    """
    ...
    try:
        ...
        for rsi_point in rsi_values:
            point_info = {'timestamp': rsi_point.get('timestamp'), 'rsi_value': rsi_point.get('value'), 'date': None}
            ...
            if rsi_val is not None:
                point_info['rsi_analysis'] = {'rsi_level': rsi_val, 'overbought': rsi_val > 70, 'oversold': rsi_val < 30, 'neutral': 30 <= rsi_val <= 70, 'extreme_overbought': rsi_val > 80, 'extreme_oversold': rsi_val < 20, 'distance_to_overbought': max(0, 70 - rsi_val) if rsi_val < 70 else 0, 'distance_to_oversold': max(0, rsi_val - 30) if rsi_val > 30 else 0}
                if rsi_val >= 80:
                ...
                point_info['divergence_potential'] = {'rsi_extreme': rsi_val > 80 or rsi_val < 20, 'reversal_probability': 'High' if rsi_val > 80 or rsi_val < 20 else 'Medium' if rsi_val >= 70 or rsi_val <= 30 else 'Low'}
        ...
        if processed_rsi:
            ...
            if rsi_values_list:
                rsi_stats = {'count': len(rsi_values_list), 'min_value': min(rsi_values_list), 'max_value': max(rsi_values_list), 'avg_value': sum(rsi_values_list) / len(rsi_values_list), 'latest_value': rsi_values_list[-1] if rsi_values_list else None, 'first_value': rsi_values_list[0] if rsi_values_list else None, 'total_change': rsi_values_list[-1] - rsi_values_list[0] if len(rsi_values_list) > 1 else 0, 'percent_change': (rsi_values_list[-1] - rsi_values_list[0]) / rsi_values_list[0] * 100 if len(rsi_values_list) > 1 and rsi_values_list[0] != 0 else 0}
            else:
            ...
            level_distribution = {'overbought_periods': overbought_periods, 'oversold_periods': oversold_periods, 'neutral_periods': neutral_periods, 'extreme_overbought': extreme_overbought, 'extreme_oversold': extreme_oversold, 'dominant_level': 'overbought' if overbought_periods > oversold_periods else 'oversold' if oversold_periods > neutral_periods else 'neutral', 'extreme_conditions': extreme_overbought + extreme_oversold}
            momentum_periods = {}
            ...
            momentum_stats = {'distribution': momentum_periods, 'dominant_momentum': max(momentum_periods.items(), key=lambda x: x[1])[0] if momentum_periods else 'neutral', 'momentum_consistency': 'High' if len(momentum_periods) == 1 else 'Medium' if len(momentum_periods) <= 3 else 'Low'}
            ...
            if latest_rsi > 80:
                ...
                action_signal = 'Hold'
            extreme_analysis = {'current_status': extreme_status, 'suggested_action': action_signal, 'rsi_level': latest_rsi, 'level_distance': {'from_overbought': max(0, 70 - latest_rsi) if latest_rsi < 70 else 0, 'from_oversold': max(0, latest_rsi - 30) if latest_rsi > 30 else 0}}
        else:
        ...
        rsi_response = {'ticker': stock_ticker, 'indicator_type': 'RSI', 'parameters': {'window': window, 'series_type': series_type, 'timespan': timespan, 'adjusted': adjusted}, 'rsi_values': processed_rsi, 'statistics': {'rsi_stats': rsi_stats, 'level_distribution': level_distribution, 'momentum_stats': momentum_stats, 'extreme_analysis': extreme_analysis}, 'underlying_url': underlying_data.get('url') if underlying_data else None}
        if expand_underlying and underlying_aggregates:
            rsi_response['underlying_aggregates'] = underlying_aggregates
        return {'success': True, 'rsi_data': rsi_response, 'next_url': result.get('next_url'), 'request_id': result.get('request_id'), 'status': result.get('status')}
    except Exception as e:
        return {'error': f'Failed to get RSI for {stock_ticker}: {str(e)}'}

def get_balance_sheets(cik: Optional[str]=None, cik_any_of: Optional[str]=None, cik_gt: Optional[str]=None, cik_gte: Optional[str]=None, cik_lt: Optional[str]=None, cik_lte: Optional[str]=None, tickers: Optional[str]=None, tickers_all_of: Optional[str]=None, tickers_any_of: Optional[str]=None, period_end: Optional[str]=None, period_end_gt: Optional[str]=None, period_end_gte: Optional[str]=None, period_end_lt: Optional[str]=None, period_end_lte: Optional[str]=None, filing_date: Optional[str]=None, filing_date_gt: Optional[str]=None, filing_date_gte: Optional[str]=None, filing_date_lt: Optional[str]=None, filing_date_lte: Optional[str]=None, fiscal_year: Optional[float]=None, fiscal_year_gt: Optional[float]=None, fiscal_year_gte: Optional[float]=None, fiscal_year_lt: Optional[float]=None, fiscal_year_lte: Optional[float]=None, fiscal_quarter: Optional[float]=None, fiscal_quarter_gt: Optional[float]=None, fiscal_quarter_gte: Optional[float]=None, fiscal_quarter_lt: Optional[float]=None, fiscal_quarter_lte: Optional[float]=None, timeframe: Optional[str]=None, timeframe_any_of: Optional[str]=None, timeframe_gt: Optional[str]=None, timeframe_gte: Optional[str]=None, timeframe_lt: Optional[str]=None, timeframe_lte: Optional[str]=None, limit: Optional[int]=None, sort: Optional[str]=None) -> Dict:
    """
    ...
    try:
        ...
        if result.get('results'):
            for balance_sheet in result['results']:
                ...
                book_value_per_share = total_equity_attributable_to_parent
                retained_earnings_ratio = balance_sheet.get('retained_earnings_deficit', 0) / total_equity if total_equity > 0 else None
                balance_sheet['financial_ratios'] = {'liquidity_ratios': {'current_ratio': round(current_ratio, 4) if current_ratio else None, 'quick_ratio': round(quick_ratio, 4) if quick_ratio else None, 'cash_ratio': round(cash_ratio, 4) if cash_ratio else None, 'liquid_ratio': round(liquid_ratio, 4) if liquid_ratio else None, 'working_capital': working_capital}, 'leverage_ratios': {'debt_to_equity': round(debt_to_equity, 4) if debt_to_equity else None, 'debt_to_assets': round(debt_to_assets, 4) if debt_to_assets else None, 'long_term_debt_to_equity': round(long_term_debt_to_equity, 4) if long_term_debt_to_equity else None, 'equity_multiplier': round(equity_multiplier, 4) if equity_multiplier else None}, 'asset_composition': {'current_assets_ratio': round(current_assets_ratio, 4) if current_assets_ratio else None, 'ppe_ratio': round(ppe_ratio, 4) if ppe_ratio else None, 'intangible_ratio': round(intangible_ratio, 4) if intangible_ratio else None, 'cash_ratio_to_assets': round(cash_ratio_to_assets, 4) if cash_ratio_to_assets else None}}
                health_score = 0
                health_factors = []
                ...
                balance_sheet['financial_health'] = {'health_score': health_score, 'health_rating': health_rating, 'health_factors': health_factors, 'assessment_date': datetime.now().isoformat()}
                balance_sheet['formatted_values'] = {'total_assets': f'${total_assets:,.0f}' if total_assets else '$0', 'total_current_assets': f'${total_current_assets:,.0f}' if total_current_assets else '$0', 'total_liabilities': f'${total_liabilities:,.0f}' if total_liabilities else '$0', 'total_current_liabilities': f'${total_current_liabilities:,.0f}' if total_current_liabilities else '$0', 'total_equity': f'${total_equity:,.0f}' if total_equity else '$0', 'cash_and_equivalents': f'${cash_and_equivalents:,.0f}' if cash_and_equivalents else '$0', 'working_capital': f'${working_capital:,.0f}' if working_capital else '$0', 'property_plant_equipment_net': f'${property_plant_equipment_net:,.0f}' if property_plant_equipment_net else '$0', 'long_term_debt': f'${long_term_debt:,.0f}' if long_term_debt else '$0'}
                if balance_sheet.get('period_end') and balance_sheet.get('fiscal_year'):
                    period_info = {'period_type': balance_sheet.get('timeframe', 'unknown'), 'fiscal_year': balance_sheet.get('fiscal_year'), 'fiscal_quarter': balance_sheet.get('fiscal_quarter'), 'period_end_date': balance_sheet.get('period_end'), 'filing_date': balance_sheet.get('filing_date'), 'days_to_file': None}
        ...
        if result.get('results'):
            ...
            summary_stats = {'total_balance_sheets': len(balance_sheets), 'unique_companies': total_companies, 'unique_tickers': list(unique_tickers), 'ticker_count': len(unique_tickers), 'timeframe_distribution': timeframes, 'fiscal_year_range': {'earliest': min(fiscal_years) if fiscal_years else None, 'latest': max(fiscal_years) if fiscal_years else None, 'count': len(set(fiscal_years)) if fiscal_years else 0}, 'aggregate_metrics': {'total_assets_all_periods': total_assets_sum, 'total_equity_all_periods': total_equity_sum, 'average_assets_per_sheet': total_assets_sum / len(balance_sheets) if balance_sheets else 0, 'average_equity_per_sheet': total_equity_sum / len(balance_sheets) if balance_sheets else 0}, 'query_summary': {'parameters_used': {'cik': cik, 'tickers': tickers, 'timeframe': timeframe, 'fiscal_year': fiscal_year, 'limit': limit, 'sort': sort}, 'result_count': len(balance_sheets), 'has_next_page': bool(result.get('next_url'))}}
            result['summary_statistics'] = summary_stats
        return {'success': True, 'balance_sheet_data': result, 'query_parameters': {'cik': cik, 'tickers': tickers, 'timeframe': timeframe, 'fiscal_year': fiscal_year, 'fiscal_quarter': fiscal_quarter, 'limit': limit, 'sort': sort}}
    except Exception as e:
        return {'error': f'Failed to get balance sheets: {str(e)}'}

def get_cash_flow_statements(cik: Optional[str]=None, cik_any_of: Optional[str]=None, cik_gt: Optional[str]=None, cik_gte: Optional[str]=None, cik_lt: Optional[str]=None, cik_lte: Optional[str]=None, period_end: Optional[str]=None, period_end_gt: Optional[str]=None, period_end_gte: Optional[str]=None, period_end_lt: Optional[str]=None, period_end_lte: Optional[str]=None, filing_date: Optional[str]=None, filing_date_gt: Optional[str]=None, filing_date_gte: Optional[str]=None, filing_date_lt: Optional[str]=None, filing_date_lte: Optional[str]=None, tickers: Optional[str]=None, tickers_all_of: Optional[str]=None, tickers_any_of: Optional[str]=None, fiscal_year: Optional[float]=None, fiscal_year_gt: Optional[float]=None, fiscal_year_gte: Optional[float]=None, fiscal_year_lt: Optional[float]=None, fiscal_year_lte: Optional[float]=None, fiscal_quarter: Optional[float]=None, fiscal_quarter_gt: Optional[float]=None, fiscal_quarter_gte: Optional[float]=None, fiscal_quarter_lt: Optional[float]=None, fiscal_quarter_lte: Optional[float]=None, timeframe: Optional[str]=None, timeframe_any_of: Optional[str]=None, timeframe_gt: Optional[str]=None, timeframe_gte: Optional[str]=None, timeframe_lt: Optional[str]=None, timeframe_lte: Optional[str]=None, limit: Optional[int]=None, sort: Optional[str]=None) -> Dict:
    """
    ...
    try:
        ...
        if result.get('results'):
            for cash_flow in result['results']:
                ...
                free_cash_flow = net_cash_from_operating_activities + purchase_of_property_plant_and_equipment
                ...
                cash_flow['cash_flow_ratios'] = {'profitability_metrics': {'operating_cash_flow_margin': round(operating_cash_flow_margin, 4) if operating_cash_flow_margin else None, 'free_cash_flow': free_cash_flow, 'cash_flow_to_debt_ratio': round(cash_flow_to_debt_ratio, 4) if cash_flow_to_debt_ratio else None, 'self_financing_ratio': round(self_financing_ratio, 4) if self_financing_ratio else None}, 'investment_metrics': {'capex_ratio': round(capex_ratio, 4) if capex_ratio else None, 'capital_expenditure': purchase_of_property_plant_and_equipment, 'net_investment': net_investment, 'investment_to_operating_cf_ratio': round(net_investment / abs(net_cash_from_operating_activities), 4) if net_cash_from_operating_activities != 0 else None}, 'financing_metrics': {'dividend_payout_ratio': round(dividend_payout_ratio, 4) if dividend_payout_ratio else None, 'debt_repayment_capacity': round(debt_repayment_capacity, 4) if debt_repayment_capacity else None, 'net_financing': net_financing, 'dividend_yield_to_cf': round(abs(dividends) / net_cash_from_operating_activities, 4) if net_cash_from_operating_activities > 0 else None}, 'quality_metrics': {'cash_conversion_quality': round(cash_conversion_quality, 4) if cash_conversion_quality else None, 'working_capital_efficiency': round(working_capital_efficiency, 4) if working_capital_efficiency else None, 'non_cash_items_ratio': round(depreciation_depletion_and_amortization / abs(net_income), 4) if net_income != 0 else None}}
                health_score = 0
                health_factors = []
                ...
                if long_term_debt_issuances_repayments < 0:
                ...
                if purchase_of_property_plant_and_equipment < 0:
                ...
                if health_score >= 80:
                    ...
                    health_rating = 'Very Poor'
                cash_flow['cash_flow_health'] = {'health_score': health_score, 'health_rating': health_rating, 'health_factors': health_factors, 'assessment_date': datetime.now().isoformat()}
                cf_pattern = 'Unknown'
                if net_cash_from_operating_activities > 0 and net_cash_from_investing_activities < 0 and (net_cash_from_financing_activities < 0):
                    ...
                    cf_pattern = 'Growth/Expansion'
                elif net_cash_from_operating_activities > 0 and net_cash_from_investing_activities > 0 and (net_cash_from_financing_activities > 0):
                    cf_pattern = 'Financing/Restructuring'
                elif net_cash_from_operating_activities < 0 and net_cash_from_investing_activities > 0 and (net_cash_from_financing_activities > 0):
                    cf_pattern = 'Distress/Turnaround'
                cash_flow['cash_flow_pattern'] = {'pattern': cf_pattern, 'operating_cash_flow': net_cash_from_operating_activities, 'investing_cash_flow': net_cash_from_investing_activities, 'financing_cash_flow': net_cash_from_financing_activities, 'net_cash_change': change_in_cash_and_equivalents}
                cash_flow['formatted_values'] = {'net_income': f'${net_income:,.0f}' if net_income else '$0', 'operating_cash_flow': f'${net_cash_from_operating_activities:,.0f}' if net_cash_from_operating_activities else '$0', 'investing_cash_flow': f'${net_cash_from_investing_activities:,.0f}' if net_cash_from_investing_activities else '$0', 'financing_cash_flow': f'${net_cash_from_financing_activities:,.0f}' if net_cash_from_financing_activities else '$0', 'free_cash_flow': f'${free_cash_flow:,.0f}' if free_cash_flow else '$0', 'change_in_cash': f'${change_in_cash_and_equivalents:,.0f}' if change_in_cash_and_equivalents else '$0', 'capital_expenditure': f'${purchase_of_property_plant_and_equipment:,.0f}' if purchase_of_property_plant_and_equipment else '$0', 'dividends': f'${dividends:,.0f}' if dividends else '$0'}
                if cash_flow.get('period_end') and cash_flow.get('fiscal_year'):
                    period_info = {'period_type': cash_flow.get('timeframe', 'unknown'), 'fiscal_year': cash_flow.get('fiscal_year'), 'fiscal_quarter': cash_flow.get('fiscal_quarter'), 'period_end_date': cash_flow.get('period_end'), 'filing_date': cash_flow.get('filing_date'), 'days_to_file': None}
        ...
        if result.get('results'):
            ...
            summary_stats = {'total_cash_flow_statements': len(cash_flows), 'unique_companies': total_companies, 'unique_tickers': list(unique_tickers), 'ticker_count': len(unique_tickers), 'timeframe_distribution': timeframes, 'fiscal_year_range': {'earliest': min(fiscal_years) if fiscal_years else None, 'latest': max(fiscal_years) if fiscal_years else None, 'count': len(set(fiscal_years)) if fiscal_years else 0}, 'aggregate_cash_flows': {'total_operating_cash_flow': total_operating_cf, 'total_investing_cash_flow': total_investing_cf, 'total_financing_cash_flow': total_financing_cf, 'total_free_cash_flow': total_free_cf, 'average_operating_cash_flow': total_operating_cf / len(cash_flows) if cash_flows else 0, 'average_free_cash_flow': total_free_cf / len(cash_flows) if cash_flows else 0}, 'cash_flow_quality_metrics': {'positive_operating_cash_flow_ratio': positive_ocf_count / len(cash_flows) if cash_flows else 0, 'positive_free_cash_flow_ratio': positive_fcf_count / len(cash_flows) if cash_flows else 0, 'average_cash_flow_health_score': sum((cf.get('cash_flow_health', {}).get('health_score', 0) for cf in cash_flows)) / len(cash_flows) if cash_flows else 0}, 'query_summary': {'parameters_used': {'cik': cik, 'tickers': tickers, 'timeframe': timeframe, 'fiscal_year': fiscal_year, 'limit': limit, 'sort': sort}, 'result_count': len(cash_flows), 'has_next_page': bool(result.get('next_url'))}}
            result['summary_statistics'] = summary_stats
        return {'success': True, 'cash_flow_data': result, 'query_parameters': {'cik': cik, 'tickers': tickers, 'timeframe': timeframe, 'fiscal_year': fiscal_year, 'fiscal_quarter': fiscal_quarter, 'limit': limit, 'sort': sort}}
    except Exception as e:
        return {'error': f'Failed to get cash flow statements: {str(e)}'}

def get_income_statements(cik: Optional[str]=None, cik_any_of: Optional[str]=None, cik_gt: Optional[str]=None, cik_gte: Optional[str]=None, cik_lt: Optional[str]=None, cik_lte: Optional[str]=None, tickers: Optional[str]=None, tickers_all_of: Optional[str]=None, tickers_any_of: Optional[str]=None, period_end: Optional[str]=None, period_end_gt: Optional[str]=None, period_end_gte: Optional[str]=None, period_end_lt: Optional[str]=None, period_end_lte: Optional[str]=None, filing_date: Optional[str]=None, filing_date_gt: Optional[str]=None, filing_date_gte: Optional[str]=None, filing_date_lt: Optional[str]=None, filing_date_lte: Optional[str]=None, fiscal_year: Optional[float]=None, fiscal_year_gt: Optional[float]=None, fiscal_year_gte: Optional[float]=None, fiscal_year_lt: Optional[float]=None, fiscal_year_lte: Optional[float]=None, fiscal_quarter: Optional[float]=None, fiscal_quarter_gt: Optional[float]=None, fiscal_quarter_gte: Optional[float]=None, fiscal_quarter_lt: Optional[float]=None, fiscal_quarter_lte: Optional[float]=None, timeframe: Optional[str]=None, timeframe_any_of: Optional[str]=None, timeframe_gt: Optional[str]=None, timeframe_gte: Optional[str]=None, timeframe_lt: Optional[str]=None, timeframe_lte: Optional[str]=None, limit: Optional[int]=None, sort: Optional[str]=None) -> Dict:
    """
    ...
    try:
        ...
        if result.get('results'):
            for income_statement in result['results']:
                ...
                income_statement['profitability_ratios'] = {'margin_analysis': {'gross_profit_margin': round(gross_profit_margin, 4) if gross_profit_margin else None, 'operating_profit_margin': round(operating_profit_margin, 4) if operating_profit_margin else None, 'net_profit_margin': round(net_profit_margin, 4) if net_profit_margin else None, 'ebitda_margin': round(ebitda_margin, 4) if ebitda_margin else None}, 'efficiency_ratios': {'cost_of_revenue_ratio': round(cost_of_revenue_ratio, 4) if cost_of_revenue_ratio else None, 'sga_ratio': round(sga_ratio, 4) if sga_ratio else None, 'rd_ratio': round(rd_ratio, 4) if rd_ratio else None, 'depreciation_ratio': round(depreciation_ratio, 4) if depreciation_ratio else None}, 'financial_metrics': {'effective_tax_rate': round(effective_tax_rate, 4) if effective_tax_rate else None, 'interest_coverage_ratio': round(interest_coverage_ratio, 4) if interest_coverage_ratio else None, 'eps_quality': round(eps_quality, 4) if eps_quality else None, 'share_dilution_impact': round(share_dilution_impact, 4) if share_dilution_impact else None}, 'quality_metrics': {'operating_revenue_quality': round(operating_revenue_quality, 4) if operating_revenue_quality else None, 'net_income_quality': round(net_income_quality, 4) if net_income_quality else None, 'ebitda_to_operating_income': round(ebitda / operating_income, 4) if operating_income != 0 else None}, 'per_share_metrics': {'revenue_per_share': round(revenue_per_share, 4) if revenue_per_share else None, 'operating_income_per_share': round(operating_income_per_share, 4) if operating_income_per_share else None, 'gross_profit_per_share': round(gross_profit_per_share, 4) if gross_profit_per_share else None, 'basic_earnings_per_share': round(basic_earnings_per_share, 4) if basic_earnings_per_share else None, 'diluted_earnings_per_share': round(diluted_earnings_per_share, 4) if diluted_earnings_per_share else None}}
                health_score = 0
                health_factors = []
                ...
                if health_score >= 80:
                    ...
                    health_rating = 'Very Poor'
                income_statement['profitability_health'] = {'health_score': health_score, 'health_rating': health_rating, 'health_factors': health_factors, 'assessment_date': datetime.now().isoformat()}
                ...
                income_statement['business_model_analysis'] = {'model_type': business_model, 'gross_profit_margin': gross_profit_margin, 'operating_profit_margin': operating_profit_margin, 'characteristics': _get_business_model_characteristics(business_model)}
                income_statement['formatted_values'] = {'revenue': f'${revenue:,.0f}' if revenue else '$0', 'gross_profit': f'${gross_profit:,.0f}' if gross_profit else '$0', 'operating_income': f'${operating_income:,.0f}' if operating_income else '$0', 'net_income': f'${net_income_loss_attributable_common_shareholders:,.0f}' if net_income_loss_attributable_common_shareholders else '$0', 'ebitda': f'${ebitda:,.0f}' if ebitda else '$0', 'cost_of_revenue': f'${cost_of_revenue:,.0f}' if cost_of_revenue else '$0', 'sga_expenses': f'${selling_general_administrative:,.0f}' if selling_general_administrative else '$0', 'rd_expenses': f'${research_development:,.0f}' if research_development else '$0'}
                if income_statement.get('period_end') and income_statement.get('fiscal_year'):
                    period_info = {'period_type': income_statement.get('timeframe', 'unknown'), 'fiscal_year': income_statement.get('fiscal_year'), 'fiscal_quarter': income_statement.get('fiscal_quarter'), 'period_end_date': income_statement.get('period_end'), 'filing_date': income_statement.get('filing_date'), 'days_to_file': None}
    ...
    try:
        ...
        if result.get('results'):
            for ratio_data in result['results']:
                ...
                ratio_data['investment_analysis'] = {'investment_score': investment_score, 'investment_rating': investment_rating, 'risk_level': risk_level, 'investment_style': investment_style, 'investment_factors': investment_factors, 'risk_factors': risk_factors, 'analysis_date': datetime.now().isoformat()}
                ratio_data['valuation_assessment'] = {'pe_analysis': {'ratio': pe_ratio, 'assessment': _get_pe_assessment(pe_ratio), 'category': _get_pe_category(pe_ratio)}, 'pb_analysis': {'ratio': pb_ratio, 'assessment': _get_pb_assessment(pb_ratio), 'category': _get_pb_category(pb_ratio)}, 'ps_analysis': {'ratio': ps_ratio, 'assessment': _get_ps_assessment(ps_ratio), 'category': _get_ps_category(ps_ratio)}, 'ev_analysis': {'ev_to_ebitda': ev_ebitda_ratio, 'ev_to_sales': ev_sales_ratio, 'assessment': _get_ev_assessment(ev_ebitda_ratio, ev_sales_ratio)}}
                ratio_data['financial_health'] = {'profitability': {'roe': roe, 'roa': roa, 'assessment': _get_profitability_assessment(roe, roa)}, 'liquidity': {'current_ratio': current_ratio, 'quick_ratio': quick_ratio, 'cash_ratio': cash_ratio, 'assessment': _get_liquidity_assessment(current_ratio, quick_ratio, cash_ratio)}, 'leverage': {'debt_to_equity': debt_to_equity_ratio, 'assessment': _get_leverage_assessment(debt_to_equity_ratio)}}
                ratio_data['market_metrics'] = {'market_cap_category': _get_market_cap_category(market_cap), 'liquidity_assessment': _get_liquidity_assessment_by_volume(average_volume), 'trading_activity': {'average_volume': average_volume, 'volume_category': _get_volume_category(average_volume)}}
                ratio_data['formatted_values'] = {'price': f'${price:.2f}' if price else '$0.00', 'market_cap': f'${market_cap / 1000000:,.0f}M' if market_cap else '$0M', 'enterprise_value': f'${enterprise_value / 1000000:,.0f}M' if enterprise_value else '$0M', 'free_cash_flow': f'${free_cash_flow_amount / 1000000:,.0f}M' if free_cash_flow_amount else '$0M', 'earnings_per_share': f'${earnings_per_share_amount:.2f}' if earnings_per_share_amount else '$0.00', 'dividend_yield': f'{dividend_yield * 100:.2f}%' if dividend_yield else '0.00%'}
        if result.get('results'):
            ...
            summary_stats = {'total_companies': total_companies, 'tickers': tickers, 'key_ratio_averages': {'average_pe_ratio': round(sum(pe_ratios) / len(pe_ratios), 2) if pe_ratios else None, 'average_pb_ratio': round(sum(pb_ratios) / len(pb_ratios), 2) if pb_ratios else None, 'average_roe': round(sum(roe_values) / len(roe_values), 4) if roe_values else None, 'average_debt_to_equity': round(sum(debt_ratios) / len(debt_ratios), 2) if debt_ratios else None, 'average_dividend_yield': round(sum(dividend_yields) / len(dividend_yields), 4) if dividend_yields else None}, 'investment_rating_distribution': investment_ratings, 'market_cap_distribution': {'large_cap': large_caps, 'mid_cap': mid_caps, 'small_cap': small_caps}, 'dividend_paying_companies': len(dividend_yields), 'high_roe_companies': len([r for r in roe_values if r > 0.15]), 'low_debt_companies': len([r for r in debt_ratios if r < 0.5]), 'query_summary': {'parameters_used': {'ticker': ticker, 'cik': cik, 'limit': limit, 'sort': sort}, 'result_count': len(ratios), 'has_next_page': bool(result.get('next_url'))}}
            result['summary_statistics'] = summary_stats
        return {'success': True, 'ratios_data': result, 'query_parameters': {'ticker': ticker, 'cik': cik, 'limit': limit, 'sort': sort}}
    except Exception as e:
        return {'error': f'Failed to get financial ratios: {str(e)}'}

def get_short_interest(ticker: Optional[str]=None, ticker_any_of: Optional[str]=None, ticker_gt: Optional[str]=None, ticker_gte: Optional[str]=None, ticker_lt: Optional[str]=None, ticker_lte: Optional[str]=None, days_to_cover: Optional[float]=None, days_to_cover_any_of: Optional[str]=None, days_to_cover_gt: Optional[float]=None, days_to_cover_gte: Optional[float]=None, days_to_cover_lt: Optional[float]=None, days_to_cover_lte: Optional[float]=None, settlement_date: Optional[str]=None, settlement_date_any_of: Optional[str]=None, settlement_date_gt: Optional[str]=None, settlement_date_gte: Optional[str]=None, settlement_date_lt: Optional[str]=None, settlement_date_lte: Optional[str]=None, avg_daily_volume: Optional[int]=None, avg_daily_volume_any_of: Optional[str]=None, avg_daily_volume_gt: Optional[int]=None, avg_daily_volume_gte: Optional[int]=None, avg_daily_volume_lt: Optional[int]=None, avg_daily_volume_lte: Optional[int]=None, limit: Optional[int]=None, sort: Optional[str]=None) -> Dict:
    """
    ...
    try:
        ...
        for result in results:
            ...
            trading_recommendation = _generate_short_interest_trading_recommendation(days_to_cover, squeeze_risk, sentiment, liquidity_impact)
        ...
        return {'status': response.get('status', 'OK'), 'request_id': response.get('request_id'), 'count': len(enhanced_results), 'results': enhanced_results, 'summary': summary, 'next_url': response.get('next_url')}
    except Exception as e:
        return {'error': f'Failed to fetch short interest data: {str(e)}'}

def get_short_volume(ticker: Optional[str]=None, ticker_any_of: Optional[str]=None, ticker_gt: Optional[str]=None, ticker_gte: Optional[str]=None, ticker_lt: Optional[str]=None, ticker_lte: Optional[str]=None, date: Optional[str]=None, date_any_of: Optional[str]=None, date_gt: Optional[str]=None, date_gte: Optional[str]=None, date_lt: Optional[str]=None, date_lte: Optional[str]=None, short_volume_ratio: Optional[float]=None, short_volume_ratio_any_of: Optional[str]=None, short_volume_ratio_gt: Optional[float]=None, short_volume_ratio_gte: Optional[float]=None, short_volume_ratio_lt: Optional[float]=None, short_volume_ratio_lte: Optional[float]=None, total_volume: Optional[int]=None, total_volume_any_of: Optional[str]=None, total_volume_gt: Optional[int]=None, total_volume_gte: Optional[int]=None, total_volume_lt: Optional[int]=None, total_volume_lte: Optional[int]=None, limit: Optional[int]=None, sort: Optional[str]=None) -> Dict:
    """
    ...
    try:
        ...
        for result in results:
            ...
            volume_trading_recommendation = _generate_short_volume_trading_recommendation(short_volume_ratio, pressure, volume_sentiment, distribution)
