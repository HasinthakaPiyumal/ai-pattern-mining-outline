...
@click.option('--repeatn', help='repeat of each not up block', metavar='INT', type=click.IntRange(min=1), default=1, show_default=True)
@click.option('--refinern', help='repeat N of refiner', metavar='INT', type=click.IntRange(min=0), default=0, show_default=True)
@click.option('--start-size', help='Start size of first layer e.g.1,2,4,8...', metavar='SIZE', type=click.IntRange(min=1), default=1, show_default=True)
@click.option('--blockn-times', help='Blockn_times to times blockn', metavar='INT', type=click.IntRange(min=1), default=1, show_default=True)
...
@click.option('--diverge-shaping', help='diverge_shaping_rate', metavar='FLOAT', type=click.FloatRange(min=0.0, max=1.0), default=0, show_default=True)
...
@click.option('--ema', help='EMA half-life', metavar='MIMG', type=click.FloatRange(min=0), default=0, show_default=True)
...
def main(**kwargs):
    ...
    if opts.transfer is not None:
        ...
        c.resume_pkl = os.path.join(os.path.dirname(opts.resume), f'shot-{match.group(1)}.pkl')
