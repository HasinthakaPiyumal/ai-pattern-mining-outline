...
class TestGetText:
    ...
    def test_get_text_from_text_resource_contents(self):
        content = TextResourceContents(uri='file://test.txt', mimeType='text/plain', text='Resource text')
        assert get_text(content) == 'Resource text'

    def test_get_text_from_embedded_resource_with_text(self):
        resource = TextResourceContents(uri='file://test.txt', mimeType='text/plain', text='Embedded text')
    ...
    def test_get_text_from_embedded_resource_with_blob(self):
        resource = BlobResourceContents(uri='file://test.bin', mimeType='application/octet-stream', blob='binary_data')
        embedded = EmbeddedResource(type='resource', resource=resource)
...
class TestGetImageData:
    ...
    def test_get_image_data_from_image_content(self):
        content = ImageContent(type='image', data='base64imagedata', mimeType='image/png')
        assert get_image_data(content) == 'base64imagedata'

    def test_get_image_data_from_embedded_resource_with_blob(self):
        resource = BlobResourceContents(uri='file://image.jpg', mimeType='image/jpeg', blob='imageblob')
        embedded = EmbeddedResource(type='resource', resource=resource)
    ...
    def test_get_image_data_from_embedded_resource_with_text(self):
        resource = TextResourceContents(uri='file://test.txt', mimeType='text/plain', text='Text content')
        embedded = EmbeddedResource(type='resource', resource=resource)
...
class TestGetResourceUri:
    ...
    def test_get_resource_uri_from_embedded_resource(self):
        resource = TextResourceContents(uri='file://test.txt/', mimeType='text/plain', text='Test')
        embedded = EmbeddedResource(type='resource', resource=resource)
...
class TestIsTextContent:
    ...
    def test_is_text_content_with_text_resource_contents(self):
        content = TextResourceContents(uri='file://test.txt', mimeType='text/plain', text='Hello')
        assert is_text_content(content) is True
    ...
    def test_is_text_content_with_embedded_resource(self):
        resource = TextResourceContents(uri='file://test.txt', mimeType='text/plain', text='Hello')
        embedded = EmbeddedResource(type='resource', resource=resource)
...
class TestIsImageContent:
    ...
    def test_is_image_content_with_embedded_resource(self):
        resource = BlobResourceContents(uri='file://image.jpg', mimeType='image/jpeg', blob='imagedata')
        embedded = EmbeddedResource(type='resource', resource=resource)
