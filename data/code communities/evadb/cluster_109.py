...
class JobHistoryCatalog(BaseModel):
    ...
    _job_id = Column('job_id', Integer, ForeignKey('job_catalog._row_id', ondelete='CASCADE'))
    ...
    def __init__(self, job_id: int, job_name: str, execution_start_time: datetime, execution_end_time: datetime):
        self._job_id = job_id
    ...
    def as_dataclass(self) -> 'JobHistoryCatalogEntry':
        return JobHistoryCatalogEntry(row_id=self._row_id, job_id=self._job_id, job_name=self._job_name, execution_start_time=self._execution_start_time, execution_end_time=self._execution_end_time, created_at=self._created_at, updated_at=self._updated_at)
